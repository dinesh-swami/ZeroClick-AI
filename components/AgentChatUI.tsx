...
export function AgentChatUI({
  ...
  return (
    <div
      className={`flex flex-col bg-[#0a0a0a] shadow-2xl overflow-hidden ${isDocked ? 'h-[600px] w-[500px] rounded-t-xl sm:rounded-xl border border-[#222]' : 'h-full w-full'}`}
    >
      {/* Header */}
      <div className="flex items-center justify-between p-4 border-b border-[#222] bg-[#0a0a0a] shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          {isDocked && (
            <button
              onClick={onClose}
              className="p-1.5 rounded hover:bg-[#111] text-zinc-500 hover:text-white transition-colors"
            >
              <X className="w-4 h-4" />
            </button>
          )}
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-8">
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="bg-[#1a1a1a] border border-[#222] rounded-xl p-4 text-[13px] text-zinc-200 leading-relaxed">
              Summarize my unread emails and check if I have any scheduling conflicts this week.
              Also create a Linear issue for the Q3 roadmap feedback from Elena.
            </div>
          </div>
        </div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-[#111] border border-[#222] rounded-xl p-4">
                <p className="text-[13px] text-white mb-4">
                  I found 3 unread emails in your inbox. Here's a quick summary:
                </p>
                  ...
                  <li className="flex items-start gap-3 text-[13px]">
                    ...
                    <div>
                      ...
                      <span className="text-zinc-400">
                        Q3 roadmap sign-off needed — wants confirmation on launch date and budget.
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-[13px]">
                    ...
                    <div>
                      ...
                      <span className="text-zinc-400">
                        Design review scheduled for Thursday 2pm.
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-[13px]">
              ...
              <div className="bg-[#111] border border-[#222] rounded-xl p-4">
                <p className="text-[13px] text-white mb-2">
                  Checking your calendar for conflicts this week...
                </p>
                <div className="flex items-center gap-2 text-[12px] font-mono text-emerald-400">
                  <CheckCircle2 className="w-3.5 h-3.5" /> No conflicts found. Thursday 2pm design
                  review is clear.
                </div>
              </div>
                ...
                {logOpen && (
                  <div className="p-4 space-y-4 border-t border-[#222]">
                    <ToolCallItem
                      ...
                      time="0.3s"
                      input='{maxResults: 10, labelIds: ["UNREAD"]}'
                      output="3 messages returned"
                    />
                    <ToolCallItem
                      name="tavily.search"
                      time="0.4s"
                      input='{query: "Q3 roadmap context Elena"}'
                      output="2 relevant docs found"
                    />
                    <ToolCallItem
                      name="calendar.getEvents"
                      time="0.2s"
                      input='{timeMin: "2024-07-15", timeMax: "2024-07-19"}'
                      output="5 events, 0 conflicts"
                    />
                    <ToolCallItem
                      name="linear.createIssue"
                      time="0.3s"
                      input='{title: "Q3 Roadmap Feedback", priority: "urgent", assignee: "marcus"}'
                      output="Issue ORB-412 created ✓"
                    />
                  </div>
                )}
              </div>
              ...
              <div className="bg-[#111] border border-[#222] rounded-xl p-4">
                <p className="text-[13px] text-white leading-relaxed mb-4">
                  Done! I've created Linear issue{' '}
                  <span className="text-blue-400 cursor-pointer hover:underline">ORB-412</span> for
                  Elena's Q3 roadmap feedback, marked as{' '}
                  <span className="text-red-400">urgent</span>. No calendar conflicts this week —
                  you're clear.
                </p>
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="bg-[#1a1a1a] border border-[#222] rounded-xl p-4 text-[13px] text-zinc-200 leading-relaxed">
              Draft a reply to Elena confirming the launch date as Aug 15th and that budget is
              approved.
            </div>
          </div>
        </div>
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="bg-[#111] border border-[#222] rounded-xl p-4">
              ...
              <div className="bg-[#0a0a0a] border border-[#222] rounded-lg p-4 mb-4">
                ...
                <div className="text-[13px] text-zinc-300 leading-relaxed whitespace-pre-wrap font-sans">
                  Hey Elena, Confirming that we're locked in for August 15th as the launch date.
                  Budget has been approved — we're good to go. Let me know if you need anything else
                  before then. Best, Marcus
                </div>
              </div>
            ...
            <div className="flex items-center gap-2 pt-2">
              <div className="flex items-end gap-0.5 h-2">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="w-0.5 bg-blue-500 rounded-full h-full" />
                ))}
              </div>
        ...
        {voiceState === 'listening' && (
          <div className="flex items-center gap-3 mb-3 px-2">
            <div className="px-2.5 py-1 rounded bg-blue-500/10 border border-blue-500/20 flex items-center gap-2">
              ...
              <span className="text-[9px] font-mono tracking-widest text-blue-400 uppercase">
                Listening
              </span>
            </div>
