    ...
    if (to && to.includes(',')) {
      return to
        ...
        .map((t, i) => (
          <div
            key={i}
            className="flex items-center gap-1.5 bg-blue-50 border border-blue-100 rounded-full px-3 py-1 mr-2 text-[13px] text-blue-700 font-medium shadow-sm"
          >
            <div
      ...
      >
        ...
        <div className="p-5 flex flex-col gap-6">
          ...
          <div>
            ...
            <div
              className="flex items-center flex-wrap gap-y-2 bg-white border border-zinc-200 shadow-sm rounded-xl px-3 py-2 min-h-[44px] cursor-text"
