    ...
    <div className="flex-1 bg-[#111] flex flex-col h-full overflow-hidden">
      ...
      <div className="h-12 flex items-center justify-between px-5 border-b border-[#2a2a2a] shrink-0">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => alert('Send to Slack integration coming soon!')}
            className="inline-flex items-center gap-2 px-3 py-1.5 text-[13px] font-medium text-zinc-300 bg-[#2a2a2a] hover:bg-[#333] border border-[#333] rounded-md transition-colors"
          >
        ...
        <div className="max-w-3xl mx-auto px-8 py-6">
          ...
          <div className="mb-6 p-5 bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="text-[12px] font-bold text-zinc-400 uppercase tracking-wider font-mono">
                AI Summary
              </h4>
            </div>
            <p className="text-[13px] text-zinc-400 leading-relaxed">
              {senderName} is requesting approval on the revised Q3 milestones before end of day.
              Engineering is blocked on the timeline. Two open questions remain regarding the mobile
              launch date and budget reallocation.
            </p>
          </div>
            ...
            <div className="mb-6 p-5 bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl space-y-5 animate-in slide-in-from-top-2 duration-200">
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h5 className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider font-mono">
                    Open Questions
                  </h5>
                </div>
                <ul className="space-y-1.5 pl-5">
                  <li className="text-[13px] text-zinc-400 list-disc">
                    Confirm the mobile launch date for the new cycle
                  </li>
                  <li className="text-[13px] text-zinc-400 list-disc">
                    Approve the $40k budget reallocation to QA
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1.5 pl-5">
                  <li className="text-[13px] text-zinc-400 list-disc">
                    Sign off on roadmap before EOD
                  </li>
                  <li className="text-[13px] text-zinc-400 list-disc">
                    Notify eng team once approved
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            <button
              ...
              className="inline-flex items-center gap-2 px-3 py-2 text-[12px] font-medium text-zinc-300 bg-[#1a1a1a] hover:bg-[#222] border border-[#2a2a2a] rounded-lg transition-colors"
            >
            ...
            <button
              onClick={() => alert('Linear integration coming soon!')}
              className="inline-flex items-center gap-2 px-3 py-2 text-[12px] font-medium text-zinc-300 bg-[#1a1a1a] hover:bg-[#222] border border-[#2a2a2a] rounded-lg transition-colors"
            >
