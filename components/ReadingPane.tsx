        ...
        <div className="max-w-3xl mx-auto px-10 py-10">
          ...
          <div className="flex items-center justify-between mb-6">
            {priority ? (
              <div className="flex items-center gap-2">
                ...
                <span
                  className={`text-[11px] font-bold tracking-widest font-mono uppercase ${priority.text}`}
                >
                  {priority.label}
                </span>
              </div>
          ...
          {isDecisionLogOpen && (
            <div className="mb-8 p-6 bg-zinc-50 border border-zinc-200 rounded-2xl space-y-6 shadow-sm">
              {isDecisionLogLoading ? (
                  ...
                  {decisionLog.decisionsMade && decisionLog.decisionsMade.length > 0 && (
                    <div>
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <h5 className="text-[12px] font-bold text-zinc-600 uppercase tracking-widest">
                          Decisions Made
                        </h5>
                      </div>
                ...
                <div className="text-[12px] text-red-500 font-bold tracking-wider uppercase">
          ...
          <div className="flex flex-wrap gap-3 mb-10 min-h-[40px]">
            ...
            {!isSmartChipsLoading && smartChips?.hasMeeting && (
              <button
                onClick={() => alert('Calendar integration ready via Corsair!')}
                className="inline-flex items-center gap-2 px-4 py-2.5 text-[13px] font-bold text-zinc-700 bg-white hover:bg-zinc-50 border border-zinc-200 shadow-sm rounded-xl transition-colors"
              >
                <CalendarPlus className="w-4 h-4 text-[#1E4C82]" />
                Add to calendar
                {smartChips.suggestedTime && (
                  <span className="text-zinc-500 font-medium ml-1 bg-zinc-100 px-2 py-0.5 rounded-md">
                    {smartChips.suggestedTime}
                  </span>
                )}
              </button>
